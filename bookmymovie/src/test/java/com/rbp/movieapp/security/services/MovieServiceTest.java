...
public class MovieServiceTest {
    ...
    public void testGetAllMovies() {
        ...
        Movie movie1 = new Movie("Movie 1", "Theatre 1", 120, 120, "Book now");
        Movie movie2 = new Movie("Movie 2", "Theatre 2", 150, 150, "Book now");
        movies.add(movie1);
        movies.add(movie2);
    ...
    void getMovieByName() {
        // Set up mock data
        List<Movie> movies = new ArrayList<>();
        movies.add(new Movie("Dasara", "Miraj", 126, 126, "Book ASAP"));
        movies.add(new Movie("The Matrix", "Hollywood", 150, 150, "Experience the action"));
        movies.add(new Movie("Inception", "Hollywood", 148, 148, "Your mind is the scene of the crime"));
